# Generated by Django 3.2.18 on 2023-05-13 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.blocks')),
            ],
        ),
        migrations.CreateModel(
            name='TimeSlot',
            fields=[
                ...
                ('education_level', models.CharField(choices=[('undergraduate', 'undergraduate'), ('postgraduate', 'postgraduate')], default='undergraduate', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.office')),
            ],
        ),
        migrations.CreateModel(
