...
class AddTimeSlot(forms.Form):
    ...
    def filter_time_choices(self):
        ...
        current_time_obj = datetime.strptime(current_time_with_min, "%I:%M %p")
        # current_time_obj_alt_format = datetime.strptime(current_time_with_min, "%I %p")
        ...
        return [
            ...
            if (
                datetime.strptime(value, "%I:%M %p") >= current_time_obj 
            )  
        ]
        # return [(value, label) for value, label in self.TIME_CHOICES if datetime.strptime(value, "%I:%M %p") >= current_time_obj]
